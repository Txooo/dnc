...
### dnc开源PostgreSql类库
* npgsql 支持dapper连接PostgreSql开源数据库 
...
* MySql 是Oracle收购的开源数据库  http://mysql.com
...
* 各项目开源协议与版权归属，请查看各开源项目官方Github或官网，尊重开源知识产权
* 有github账号的朋友建议点一下这些开源项目Star可收藏
* 还没有github账号的朋友，建议赶紧注册一个，一起迎接dnc开源新时代
